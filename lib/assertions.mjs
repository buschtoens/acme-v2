...
/**
 * Asserts that the provided object is an instance of {@link Order}.
 * @param {Object} order
 * @throws {TypeError}
 */
export function assertIsOrder(order) {
  if (!(order instanceof Order))
    throw new TypeError(
      `Expected 'order' to be an instance of 'Order'. Instead got: ${order}`
    );
}
